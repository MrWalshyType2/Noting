...
namespace Noting.Migrations
{
    ...
    [Migration("20210115142143_FixedMissingCorrectField")]
    partial class FixedMissingCorrectField
    {
            ...
            modelBuilder.Entity("Noting.Models.SpacedRepetitionAttempt", b =>
                {
                    ...
                    b.Property<string>("SpacedRepetitionHistoryId1")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("SpacedRepetitionHistoryId1")
                        .IsUnique()
                        .HasFilter("[SpacedRepetitionHistoryId1] IS NOT NULL");
            ...
            modelBuilder.Entity("Noting.Models.SpacedRepetitionAttempt", b =>
                {
                    ...
                    b.HasOne("Noting.Models.SpacedRepetitionHistory", null)
                        .WithOne("LastAttempt")
                        .HasForeignKey("Noting.Models.SpacedRepetitionAttempt", "SpacedRepetitionHistoryId1");
